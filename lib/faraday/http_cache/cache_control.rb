module Faraday
  module HttpCache
    ...
    class CacheControl
      ...
      #
      # Returns nil the 'max-age' directive isn't present.
      def max_age
      ...
      #
      # Returns nil the 's-maxage' directive isn't present.
      def shared_max_age
      ...
      #   separated by commas. Directives with a 'true' value will be omit the
